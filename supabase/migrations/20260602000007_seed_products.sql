...
(
  'LX-TP-002',
  'Beige Lucky Cat Graphic T-Shirt',
  'A premium beige crew-neck short-sleeved t-shirt featuring a prominent, bold blue graphic print of a cartoon lucky cat on the front.',
  285.00, NULL,
  '100% Organic Cotton',
  'tops', 't-shirt', 'women', 'LuxeLabel',
  ARRAY['graphic','streetwear','casual','t-shirt','lucky-cat'],
  ARRAY['XS','S','M','L','XL'],
  ARRAY['beige','blue'],
